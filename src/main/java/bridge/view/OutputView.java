...
public class OutputView {
    ...
    private final static String IS_SUCCESS_MESSAGE = "게임 성공 여부: %s";
    private final static String NUMBER_OF_TRIAL_MESSAGE = "총 시도한 횟수: %d";
    ...
    public static void printEndingMessage(String isSuccess, int numberOfTrial) {
        System.out.println(String.format(IS_SUCCESS_MESSAGE, isSuccess));
        System.out.println(String.format(NUMBER_OF_TRIAL_MESSAGE, numberOfTrial));
    }
}
